 ...
 *
 */
class ApiDocs implements iProvideMultiVersionApi
{
	 ...
	 *
	 * Serves apidocs html, css, and js files
	 *
	 * @url GET *
	 *
	...
	public function get()
	{
		if (func_num_args() > 1 && func_get_arg(0) == 'ApiDocs')
		{
			/**
			 * BUGFIX:
		...
		PassThrough::file(__DIR__ . '/apidocs/' . (empty($filename) ? 'index.html' : $filename), false,
			0); //60 * 60 * 24);
	}
